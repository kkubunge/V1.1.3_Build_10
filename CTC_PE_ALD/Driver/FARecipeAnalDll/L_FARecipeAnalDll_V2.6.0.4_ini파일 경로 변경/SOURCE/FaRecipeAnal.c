...
////////////////////////////////////////////////////////////////////////////////////////////////
// 2006.10.20
#define CONFIG_FILE_NAME	".\\Parameter\\EQ_SETTING\\FaRecipeAnal.ini"
									...
									for(i = 0; i < nSizeLocal_Route ; i++)
									{
										...
										if(cnt == 4)
										{
											...
											else
											{
												...
												if(gCMLotPre[1] == gCMLotPre[gLCStart])  //... Compare First Lot Pre Type And Final Lot Pre Type 
												{
													startmode = 1; 		
												}
												else    //... Don't Match Lot Pre Type 
												{
													startmode = 2; 			
												}
											}
