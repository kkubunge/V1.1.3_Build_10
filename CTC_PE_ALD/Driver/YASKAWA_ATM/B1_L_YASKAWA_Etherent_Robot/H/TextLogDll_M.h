...
// Log File Name
#define LOG_FILE_PATH				"f:\\datalog\\_Log\\NXC100_ATM.log"
...
//--------------------------------------------------------------------
// Initialization
#define	_gINIT_LOG()	_gInitLogDll(LOG_FILE_PATH, CFG_FILE_PATH, TRUE)
...
static void _gLoadLogDll()
{
	...
	{
		g_hLogDllModule = LoadLibrary("TextLog_ATM.dll");
		if(NULL != g_hLogDllModule)
		{
