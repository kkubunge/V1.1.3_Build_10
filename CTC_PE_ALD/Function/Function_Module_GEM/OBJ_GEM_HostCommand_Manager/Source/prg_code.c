...
enum	{ Normal_0 , Reserved_1 };
enum	{ ACK_0,	NACK_1,		NACK_2,		NACK_3,		NACK_4,		NACK_5,		NACK_6 };
enum	{ Idle_0,	Run_1 };
//------------------------------------------------------------------------------------------
...
IO_Name_String_Map IO_STR_Map_Table[] = {
	...
	{	"PM1.DryCleaningReserveDI"		,	_K_D_IO	,	PM1_DryCleaningReserveDI		,	0		} ,
	{	"PM2.DryCleaningReserveDI"		,	_K_D_IO	,	PM2_DryCleaningReserveDI		,	0		} ,
	{	"PM3.DryCleaningReserveDI"		,	_K_D_IO	,	PM3_DryCleaningReserveDI		,	0		} ,
	{	"PM4.DryCleaningReserveDI"		,	_K_D_IO	,	PM4_DryCleaningReserveDI		,	0		} ,
/*
	{	"PRMS_PM2_AutoDryCleain_Rcp1"	,	_K_S_IO	,	PRMS_PM2_AutoDryCleain_Rcp1		,	0		} ,
	{	"PRMS_PM2_AutoDryCleain_Rcp2"	,	_K_S_IO	,	PRMS_PM2_AutoDryCleain_Rcp2		,	0		} ,
	{	"PRMS_PM3_AutoDryCleain_Rcp1"	,	_K_S_IO	,	PRMS_PM3_AutoDryCleain_Rcp1		,	0		} ,
	{	"PRMS_PM3_AutoDryCleain_Rcp2"	,	_K_S_IO	,	PRMS_PM3_AutoDryCleain_Rcp2		,	0		} ,
	{	"PRMS_PM4_AutoDryCleain_Rcp1"	,	_K_S_IO	,	PRMS_PM4_AutoDryCleain_Rcp1		,	0		} ,
	{	"PRMS_PM4_AutoDryCleain_Rcp2"	,	_K_S_IO	,	PRMS_PM4_AutoDryCleain_Rcp2		,	0		} ,
	{	"PRMS_PM5_AutoDryCleain_Rcp1"	,	_K_S_IO	,	PRMS_PM5_AutoDryCleain_Rcp1		,	0		} ,
	{	"PRMS_PM5_AutoDryCleain_Rcp2"	,	_K_S_IO	,	PRMS_PM5_AutoDryCleain_Rcp2		,	0		} ,
*/
	{	"PRMS_PM1_PreMRcp_01"			,	_K_S_IO	,	PRMS_PM1_PreMRcp_01				,	0		} ,
	{	"PRMS_PM1_PreMRcp_02"			,	_K_S_IO	,	PRMS_PM1_PreMRcp_02				,	0		} ,
	{	"PRMS_PM1_PreMRcp_03"			,	_K_S_IO	,	PRMS_PM1_PreMRcp_03				,	0		} ,
	{	"PRMS_PM1_PreMRcp_04"			,	_K_S_IO	,	PRMS_PM1_PreMRcp_04				,	0		} ,
	{	"PRMS_PM1_PreMRcp_05"			,	_K_S_IO	,	PRMS_PM1_PreMRcp_05				,	0		} ,
	{	"PRMS_PM1_PreMRcp_06"			,	_K_S_IO	,	PRMS_PM1_PreMRcp_06				,	0		} ,

	{	"PRMS_PM1_PreMRcp2_01"			,	_K_S_IO	,	PRMS_PM1_PreMRcp2_01			,	0		} ,
	{	"PRMS_PM1_PreMRcp2_02"			,	_K_S_IO	,	PRMS_PM1_PreMRcp2_02			,	0		} ,
	{	"PRMS_PM1_PreMRcp2_03"			,	_K_S_IO	,	PRMS_PM1_PreMRcp2_03			,	0		} ,
	{	"PRMS_PM1_PreMRcp2_04"			,	_K_S_IO	,	PRMS_PM1_PreMRcp2_04			,	0		} ,
	{	"PRMS_PM1_PreMRcp2_05"			,	_K_S_IO	,	PRMS_PM1_PreMRcp2_05			,	0		} ,
	{	"PRMS_PM1_PreMRcp2_06"			,	_K_S_IO	,	PRMS_PM1_PreMRcp2_06			,	0		} ,

	{	"PRMS_PM2_PreMRcp_01"			,	_K_S_IO	,	PRMS_PM2_PreMRcp_01				,	0		} ,
	{	"PRMS_PM2_PreMRcp_02"			,	_K_S_IO	,	PRMS_PM2_PreMRcp_02				,	0		} ,
	{	"PRMS_PM2_PreMRcp_03"			,	_K_S_IO	,	PRMS_PM2_PreMRcp_03				,	0		} ,
	{	"PRMS_PM2_PreMRcp_04"			,	_K_S_IO	,	PRMS_PM2_PreMRcp_04				,	0		} ,
	{	"PRMS_PM2_PreMRcp_05"			,	_K_S_IO	,	PRMS_PM2_PreMRcp_05				,	0		} ,
	{	"PRMS_PM2_PreMRcp_06"			,	_K_S_IO	,	PRMS_PM2_PreMRcp_06				,	0		} ,

	{	"PRMS_PM2_PreMRcp2_01"			,	_K_S_IO	,	PRMS_PM2_PreMRcp2_01			,	0		} ,
	{	"PRMS_PM2_PreMRcp2_02"			,	_K_S_IO	,	PRMS_PM2_PreMRcp2_02			,	0		} ,
	{	"PRMS_PM2_PreMRcp2_03"			,	_K_S_IO	,	PRMS_PM2_PreMRcp2_03			,	0		} ,
	{	"PRMS_PM2_PreMRcp2_04"			,	_K_S_IO	,	PRMS_PM2_PreMRcp2_04			,	0		} ,
	{	"PRMS_PM2_PreMRcp2_05"			,	_K_S_IO	,	PRMS_PM2_PreMRcp2_05			,	0		} ,
	{	"PRMS_PM2_PreMRcp2_06"			,	_K_S_IO	,	PRMS_PM2_PreMRcp2_06			,	0		} ,

	{	"PRMS_PM3_PreMRcp_01"			,	_K_S_IO	,	PRMS_PM3_PreMRcp_01				,	0		} ,
	{	"PRMS_PM3_PreMRcp_02"			,	_K_S_IO	,	PRMS_PM3_PreMRcp_02				,	0		} ,
	{	"PRMS_PM3_PreMRcp_03"			,	_K_S_IO	,	PRMS_PM3_PreMRcp_03				,	0		} ,
	{	"PRMS_PM3_PreMRcp_04"			,	_K_S_IO	,	PRMS_PM3_PreMRcp_04				,	0		} ,
	{	"PRMS_PM3_PreMRcp_05"			,	_K_S_IO	,	PRMS_PM3_PreMRcp_05				,	0		} ,
	{	"PRMS_PM3_PreMRcp_06"			,	_K_S_IO	,	PRMS_PM3_PreMRcp_06				,	0		} ,

	{	"PRMS_PM3_PreMRcp2_01"			,	_K_S_IO	,	PRMS_PM3_PreMRcp2_01			,	0		} ,
	{	"PRMS_PM3_PreMRcp2_02"			,	_K_S_IO	,	PRMS_PM3_PreMRcp2_02			,	0		} ,
	{	"PRMS_PM3_PreMRcp2_03"			,	_K_S_IO	,	PRMS_PM3_PreMRcp2_03			,	0		} ,
	{	"PRMS_PM3_PreMRcp2_04"			,	_K_S_IO	,	PRMS_PM3_PreMRcp2_04			,	0		} ,
	{	"PRMS_PM3_PreMRcp2_05"			,	_K_S_IO	,	PRMS_PM3_PreMRcp2_05			,	0		} ,
	{	"PRMS_PM3_PreMRcp2_06"			,	_K_S_IO	,	PRMS_PM3_PreMRcp2_06			,	0		} ,

	{	"PRMS_PM4_PreMRcp_01"			,	_K_S_IO	,	PRMS_PM4_PreMRcp_01				,	0		} ,
	{	"PRMS_PM4_PreMRcp_02"			,	_K_S_IO	,	PRMS_PM4_PreMRcp_02				,	0		} ,
	{	"PRMS_PM4_PreMRcp_03"			,	_K_S_IO	,	PRMS_PM4_PreMRcp_03				,	0		} ,
	{	"PRMS_PM4_PreMRcp_04"			,	_K_S_IO	,	PRMS_PM4_PreMRcp_04				,	0		} ,
	{	"PRMS_PM4_PreMRcp_05"			,	_K_S_IO	,	PRMS_PM4_PreMRcp_05				,	0		} ,
	{	"PRMS_PM4_PreMRcp_06"			,	_K_S_IO	,	PRMS_PM4_PreMRcp_06				,	0		} ,

	{	"PRMS_PM4_PreMRcp2_01"			,	_K_S_IO	,	PRMS_PM4_PreMRcp2_01			,	0		} ,
	{	"PRMS_PM4_PreMRcp2_02"			,	_K_S_IO	,	PRMS_PM4_PreMRcp2_02			,	0		} ,
	{	"PRMS_PM4_PreMRcp2_03"			,	_K_S_IO	,	PRMS_PM4_PreMRcp2_03			,	0		} ,
	{	"PRMS_PM4_PreMRcp2_04"			,	_K_S_IO	,	PRMS_PM4_PreMRcp2_04			,	0		} ,
	{	"PRMS_PM4_PreMRcp2_05"			,	_K_S_IO	,	PRMS_PM4_PreMRcp2_05			,	0		} ,
	{	"PRMS_PM4_PreMRcp2_06"			,	_K_S_IO	,	PRMS_PM4_PreMRcp2_06			,	0		} ,

	{	"PRMS_PM1_PostMRcp_01"			,	_K_S_IO	,	PRMS_PM1_PostMRcp_01				,	0		} ,
	{	"PRMS_PM1_PostMRcp_02"			,	_K_S_IO	,	PRMS_PM1_PostMRcp_02				,	0		} ,
	{	"PRMS_PM1_PostMRcp_03"			,	_K_S_IO	,	PRMS_PM1_PostMRcp_03				,	0		} ,
	{	"PRMS_PM1_PostMRcp_04"			,	_K_S_IO	,	PRMS_PM1_PostMRcp_04				,	0		} ,
	{	"PRMS_PM1_PostMRcp_05"			,	_K_S_IO	,	PRMS_PM1_PostMRcp_05				,	0		} ,
	{	"PRMS_PM1_PostMRcp_06"			,	_K_S_IO	,	PRMS_PM1_PostMRcp_06				,	0		} ,
                                                                                          
	{	"PRMS_PM1_PostMRcp2_01"			,	_K_S_IO	,	PRMS_PM1_PostMRcp2_01			,	0		} ,
	{	"PRMS_PM1_PostMRcp2_02"			,	_K_S_IO	,	PRMS_PM1_PostMRcp2_02			,	0		} ,
	{	"PRMS_PM1_PostMRcp2_03"			,	_K_S_IO	,	PRMS_PM1_PostMRcp2_03			,	0		} ,
	{	"PRMS_PM1_PostMRcp2_04"			,	_K_S_IO	,	PRMS_PM1_PostMRcp2_04			,	0		} ,
	{	"PRMS_PM1_PostMRcp2_05"			,	_K_S_IO	,	PRMS_PM1_PostMRcp2_05			,	0		} ,
	{	"PRMS_PM1_PostMRcp2_06"			,	_K_S_IO	,	PRMS_PM1_PostMRcp2_06			,	0		} ,

	{	"PRMS_PM2_PostMRcp_01"			,	_K_S_IO	,	PRMS_PM2_PostMRcp_01				,	0		} ,
	{	"PRMS_PM2_PostMRcp_02"			,	_K_S_IO	,	PRMS_PM2_PostMRcp_02				,	0		} ,
	{	"PRMS_PM2_PostMRcp_03"			,	_K_S_IO	,	PRMS_PM2_PostMRcp_03				,	0		} ,
	{	"PRMS_PM2_PostMRcp_04"			,	_K_S_IO	,	PRMS_PM2_PostMRcp_04				,	0		} ,
	{	"PRMS_PM2_PostMRcp_05"			,	_K_S_IO	,	PRMS_PM2_PostMRcp_05				,	0		} ,
	{	"PRMS_PM2_PostMRcp_06"			,	_K_S_IO	,	PRMS_PM2_PostMRcp_06				,	0		} ,
                                                                                          
	{	"PRMS_PM2_PostMRcp2_01"			,	_K_S_IO	,	PRMS_PM2_PostMRcp2_01			,	0		} ,
	{	"PRMS_PM2_PostMRcp2_02"			,	_K_S_IO	,	PRMS_PM2_PostMRcp2_02			,	0		} ,
	{	"PRMS_PM2_PostMRcp2_03"			,	_K_S_IO	,	PRMS_PM2_PostMRcp2_03			,	0		} ,
	{	"PRMS_PM2_PostMRcp2_04"			,	_K_S_IO	,	PRMS_PM2_PostMRcp2_04			,	0		} ,
	{	"PRMS_PM2_PostMRcp2_05"			,	_K_S_IO	,	PRMS_PM2_PostMRcp2_05			,	0		} ,
	{	"PRMS_PM2_PostMRcp2_06"			,	_K_S_IO	,	PRMS_PM2_PostMRcp2_06			,	0		} ,
                                                                                          
	{	"PRMS_PM3_PostMRcp_01"			,	_K_S_IO	,	PRMS_PM3_PostMRcp_01				,	0		} ,
	{	"PRMS_PM3_PostMRcp_02"			,	_K_S_IO	,	PRMS_PM3_PostMRcp_02				,	0		} ,
	{	"PRMS_PM3_PostMRcp_03"			,	_K_S_IO	,	PRMS_PM3_PostMRcp_03				,	0		} ,
	{	"PRMS_PM3_PostMRcp_04"			,	_K_S_IO	,	PRMS_PM3_PostMRcp_04				,	0		} ,
	{	"PRMS_PM3_PostMRcp_05"			,	_K_S_IO	,	PRMS_PM3_PostMRcp_05				,	0		} ,
	{	"PRMS_PM3_PostMRcp_06"			,	_K_S_IO	,	PRMS_PM3_PostMRcp_06				,	0		} ,
                                                                                          
	{	"PRMS_PM3_PostMRcp2_01"			,	_K_S_IO	,	PRMS_PM3_PostMRcp2_01			,	0		} ,
	{	"PRMS_PM3_PostMRcp2_02"			,	_K_S_IO	,	PRMS_PM3_PostMRcp2_02			,	0		} ,
	{	"PRMS_PM3_PostMRcp2_03"			,	_K_S_IO	,	PRMS_PM3_PostMRcp2_03			,	0		} ,
	{	"PRMS_PM3_PostMRcp2_04"			,	_K_S_IO	,	PRMS_PM3_PostMRcp2_04			,	0		} ,
	{	"PRMS_PM3_PostMRcp2_05"			,	_K_S_IO	,	PRMS_PM3_PostMRcp2_05			,	0		} ,
	{	"PRMS_PM3_PostMRcp2_06"			,	_K_S_IO	,	PRMS_PM3_PostMRcp2_06			,	0		} ,
                                                                                          
	{	"PRMS_PM4_PostMRcp_01"			,	_K_S_IO	,	PRMS_PM4_PostMRcp_01				,	0		} ,
	{	"PRMS_PM4_PostMRcp_02"			,	_K_S_IO	,	PRMS_PM4_PostMRcp_02				,	0		} ,
	{	"PRMS_PM4_PostMRcp_03"			,	_K_S_IO	,	PRMS_PM4_PostMRcp_03				,	0		} ,
	{	"PRMS_PM4_PostMRcp_04"			,	_K_S_IO	,	PRMS_PM4_PostMRcp_04				,	0		} ,
	{	"PRMS_PM4_PostMRcp_05"			,	_K_S_IO	,	PRMS_PM4_PostMRcp_05				,	0		} ,
	{	"PRMS_PM4_PostMRcp_06"			,	_K_S_IO	,	PRMS_PM4_PostMRcp_06				,	0		} ,
                                                                                          
	{	"PRMS_PM4_PostMRcp2_01"			,	_K_S_IO	,	PRMS_PM4_PostMRcp2_01			,	0		} ,
	{	"PRMS_PM4_PostMRcp2_02"			,	_K_S_IO	,	PRMS_PM4_PostMRcp2_02			,	0		} ,
	{	"PRMS_PM4_PostMRcp2_03"			,	_K_S_IO	,	PRMS_PM4_PostMRcp2_03			,	0		} ,
	{	"PRMS_PM4_PostMRcp2_04"			,	_K_S_IO	,	PRMS_PM4_PostMRcp2_04			,	0		} ,
	{	"PRMS_PM4_PostMRcp2_05"			,	_K_S_IO	,	PRMS_PM4_PostMRcp2_05			,	0		} ,
	{	"PRMS_PM4_PostMRcp2_06"			,	_K_S_IO	,	PRMS_PM4_PostMRcp2_06			,	0		} ,
                                                                                          
	{	"PRMS_PM1_MacroName_01"			,	_K_S_IO	,	PRMS_PM1_MacroName_01			,	0		} ,
	{	"PRMS_PM1_MacroName_02"			,	_K_S_IO	,	PRMS_PM1_MacroName_02			,	0		} ,
	{	"PRMS_PM1_MacroName_03"			,	_K_S_IO	,	PRMS_PM1_MacroName_03			,	0		} ,
	{	"PRMS_PM1_MacroName_04"			,	_K_S_IO	,	PRMS_PM1_MacroName_04			,	0		} ,
	{	"PRMS_PM1_MacroName_05"			,	_K_S_IO	,	PRMS_PM1_MacroName_05			,	0		} ,
	{	"PRMS_PM1_MacroName_06"			,	_K_S_IO	,	PRMS_PM1_MacroName_06			,	0		} ,

	{	"PRMS_PM2_MacroName_01"			,	_K_S_IO	,	PRMS_PM2_MacroName_01			,	0		} ,
	{	"PRMS_PM2_MacroName_02"			,	_K_S_IO	,	PRMS_PM2_MacroName_02			,	0		} ,
	{	"PRMS_PM2_MacroName_03"			,	_K_S_IO	,	PRMS_PM2_MacroName_03			,	0		} ,
	{	"PRMS_PM2_MacroName_04"			,	_K_S_IO	,	PRMS_PM2_MacroName_04			,	0		} ,
	{	"PRMS_PM2_MacroName_05"			,	_K_S_IO	,	PRMS_PM2_MacroName_05			,	0		} ,
	{	"PRMS_PM2_MacroName_06"			,	_K_S_IO	,	PRMS_PM2_MacroName_06			,	0		} ,

	{	"PRMS_PM3_MacroName_01"			,	_K_S_IO	,	PRMS_PM3_MacroName_01			,	0		} ,
	{	"PRMS_PM3_MacroName_02"			,	_K_S_IO	,	PRMS_PM3_MacroName_02			,	0		} ,
	{	"PRMS_PM3_MacroName_03"			,	_K_S_IO	,	PRMS_PM3_MacroName_03			,	0		} ,
	{	"PRMS_PM3_MacroName_04"			,	_K_S_IO	,	PRMS_PM3_MacroName_04			,	0		} ,
	{	"PRMS_PM3_MacroName_05"			,	_K_S_IO	,	PRMS_PM3_MacroName_05			,	0		} ,
	{	"PRMS_PM3_MacroName_06"			,	_K_S_IO	,	PRMS_PM3_MacroName_06			,	0		} ,

	{	"PRMS_PM4_MacroName_01"			,	_K_S_IO	,	PRMS_PM4_MacroName_01			,	0		} ,
	{	"PRMS_PM4_MacroName_02"			,	_K_S_IO	,	PRMS_PM4_MacroName_02			,	0		} ,
	{	"PRMS_PM4_MacroName_03"			,	_K_S_IO	,	PRMS_PM4_MacroName_03			,	0		} ,
	{	"PRMS_PM4_MacroName_04"			,	_K_S_IO	,	PRMS_PM4_MacroName_04			,	0		} ,
	{	"PRMS_PM4_MacroName_05"			,	_K_S_IO	,	PRMS_PM4_MacroName_05			,	0		} ,
	{	"PRMS_PM4_MacroName_06"			,	_K_S_IO	,	PRMS_PM4_MacroName_06			,	0		} ,
...
*/
	{	"HOSTCMD_HCACK"				,	_K_D_IO	,	HOSTCMD_HCACK		,	0		} ,
	{	"OBJ_MACRO_MANIT_PM1"		,	_K_F_IO	,	MACRO_MANIT_PM1		,	0		} ,		
	{	"OBJ_MACRO_MANIT_PM2"		,	_K_F_IO	,	MACRO_MANIT_PM2		,	0		} ,
	{	"OBJ_MACRO_MANIT_PM3"		,	_K_F_IO	,	MACRO_MANIT_PM3		,	0		} ,	
""
};
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
...
Module_Status AutoPM_Control( char *Data ) 
{
	char szProcessModule[256] , szAutoPMJob[256] , szMacroType[256], szRemainStr1[256];
	char szDryCleaningRecipe[256];
	char szPMAutoDryCleaningRcp1[256], szPMAutoDryCleaningRcp2[256];
	int nCommStatus, nPMID;
	char szEvent[256];
	char szMacroName[256];
	int nCnt;
	char szPreMacroRecipe1[256],szPreMacroRecipe2[256];
	char szPostMacroRecipe1[256],szPostMacroRecipe2[256];

	memset(szEvent				,		0	,	sizeof(szEvent)		);
	memset(szProcessModule		,		0	,	sizeof(szProcessModule)		);
	memset(szAutoPMJob			,		0	,	sizeof(szAutoPMJob)		);
	memset(szMacroType			,		0	,	sizeof(szMacroType)	);
	memset(szRemainStr1			,		0	,	sizeof(szRemainStr1)		);
	memset(szDryCleaningRecipe	,		0	,   sizeof(szDryCleaningRecipe)	);
	memset(szPMAutoDryCleaningRcp1,		0	,	sizeof(szPMAutoDryCleaningRcp1));
	memset(szPMAutoDryCleaningRcp2,		0	,	sizeof(szPMAutoDryCleaningRcp2));
	memset(szMacroName,					0	,	sizeof(szMacroName));
	memset(szPreMacroRecipe1,			0	,	sizeof(szPreMacroRecipe1));
	memset(szPreMacroRecipe2,			0	,	sizeof(szPreMacroRecipe2));
	memset(szPostMacroRecipe1,			0	,	sizeof(szPostMacroRecipe1));
	memset(szPostMacroRecipe2,			0	,	sizeof(szPostMacroRecipe2));

	STR_SEPERATE_CHAR( Data, '|', szAutoPMJob, szRemainStr1, 255 );
	STR_SEPERATE_CHAR( szRemainStr1, '|', szProcessModule, szMacroType, 255 );

	sprintf(szEvent,"%s %s %s",szAutoPMJob,szProcessModule,szMacroType);
	...
	if( STRCMP_L( szProcessModule, "PM1"))	{
		...
		WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
		printf("AutoPM AutoDryCleaning Command Error, At least command parameter(ChamberID) is not match.\n");
		return SYS_ABORTED;
	}

	if ( STRCMP_L(szAutoPMJob, "PMJobCreate"))
	{
		if(STRCMP_L(szMacroType,"WetPM")){
			printf("AutoPM WetPM\n");
		}
		else if(STRCMP_L(szMacroType,"DryClean")){
			printf("AutoPM DryClean\n");
		}
		else{
			WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
			printf("AutoPM AutoDryCleaning Command[MacroName] Error\n");
			return SYS_ABORTED;
		...
		case 1 :
			{
				...
				{
					READ_STRING(PRMS_PM1_MacroName_01+nCnt,szMacroName, &nCommStatus);
					if(STRCMP_L(szMacroType, szMacroName))
					{
						READ_STRING(PRMS_PM1_PreMRcp_01+nCnt, szPreMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM1_PreMRcp2_01+nCnt, szPreMacroRecipe2, &nCommStatus);
						READ_STRING(PRMS_PM1_PostMRcp_01+nCnt, szPostMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM1_PostMRcp2_01+nCnt, szPostMacroRecipe2, &nCommStatus);

						if((STRCMP_L(szPreMacroRecipe1,"") && STRCMP_L(szPreMacroRecipe2,""))
							&&(STRCMP_L(szPostMacroRecipe1,"") && STRCMP_L(szPostMacroRecipe2,"")))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM1 AutoDryCleaning Recipe is Null, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						
						if ( Reserved_1 == READ_DIGITAL(PM1_DryCleaningReserveDI, &nCommStatus))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM1 AutoDryCleaning Already Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else if (7 == READ_DIGITAL(CTC_PM1_CommStatus, &nCommStatus))
						{

							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM1,szEvent);
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_4, &nCommStatus);
							printf("PM1 AutoDryCleaning Reserved, will be command perform after StandbyMode.\n");
							return SYS_ABORTED;
						}
						else if ( (7 != READ_DIGITAL(CTC_PM1_CommStatus, &nCommStatus)) && (3 != READ_DIGITAL(CTC_PM1_CommStatus, &nCommStatus)))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM2 AutoDryCleaning Module Status isn't CTCinUse or Standby.\n");
							return SYS_ABORTED;
						}
						else{
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM1,szEvent);
				...
				WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
				printf("PM1 AutoDryCleaning Command Error, At least command parameter(MacroName) is not match.\n");
				return SYS_ABORTED;
			}
			break;
		case 2 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					READ_STRING(PRMS_PM2_MacroName_01+nCnt,szMacroName, &nCommStatus);
					if(STRCMP_L(szMacroType, szMacroName))
					{
						READ_STRING(PRMS_PM2_PreMRcp_01+nCnt, szPreMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM2_PreMRcp2_01+nCnt, szPreMacroRecipe2, &nCommStatus);
						READ_STRING(PRMS_PM2_PostMRcp_01+nCnt, szPostMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM2_PostMRcp2_01+nCnt, szPostMacroRecipe2, &nCommStatus);

						if((STRCMP_L(szPreMacroRecipe1,"") && STRCMP_L(szPreMacroRecipe2,""))
							&&(STRCMP_L(szPostMacroRecipe1,"") && STRCMP_L(szPostMacroRecipe2,"")))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM2 AutoDryCleaning Recipe is Null, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						
						if ( Reserved_1 == READ_DIGITAL(PM2_DryCleaningReserveDI, &nCommStatus))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM2 AutoDryCleaning Already Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else if (7 == READ_DIGITAL(CTC_PM2_CommStatus, &nCommStatus))
						{

							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM2,szEvent);
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_4, &nCommStatus);
							printf("PM2 AutoDryCleaning Reserved, will be command perform after StandbyMode.\n");
							return SYS_ABORTED;
						}
						else if ( (7 != READ_DIGITAL(CTC_PM2_CommStatus, &nCommStatus)) && (3 != READ_DIGITAL(CTC_PM2_CommStatus, &nCommStatus)))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM2 AutoDryCleaning Module Status isn't CTCinUse or Standby.\n");
							return SYS_ABORTED;
				...
				WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
				printf("PM2 AutoDryCleaning Command Error, At least command parameter(MacroName) is not match.\n");
				return SYS_ABORTED;
			}
			break;
		case 3 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					READ_STRING(PRMS_PM3_MacroName_01+nCnt,szMacroName, &nCommStatus);
					if(STRCMP_L(szMacroType, szMacroName))
					{
						READ_STRING(PRMS_PM3_PreMRcp_01+nCnt, szPreMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM3_PreMRcp2_01+nCnt, szPreMacroRecipe2, &nCommStatus);
						READ_STRING(PRMS_PM3_PostMRcp_01+nCnt, szPostMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM3_PostMRcp2_01+nCnt, szPostMacroRecipe2, &nCommStatus);

						if((STRCMP_L(szPreMacroRecipe1,"") && STRCMP_L(szPreMacroRecipe2,""))
							&&(STRCMP_L(szPostMacroRecipe1,"") && STRCMP_L(szPostMacroRecipe2,"")))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM3 AutoDryCleaning Recipe is Null, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						
						if ( Reserved_1 == READ_DIGITAL(PM3_DryCleaningReserveDI, &nCommStatus))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM3 AutoDryCleaning Already Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else if (7 == READ_DIGITAL(CTC_PM3_CommStatus, &nCommStatus))
						{

							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM3,szEvent);
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_4, &nCommStatus);
							printf("PM3 AutoDryCleaning Reserved, will be command perform after StandbyMode.\n");
							return SYS_ABORTED;
						}
						else if ( (7 != READ_DIGITAL(CTC_PM3_CommStatus, &nCommStatus)) && (3 != READ_DIGITAL(CTC_PM3_CommStatus, &nCommStatus)))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM3 AutoDryCleaning Module Status isn't CTCinUse or Standby.\n");
							return SYS_ABORTED;
						}
						else{
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM3,szEvent);
				...
				WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
				printf("PM3 AutoDryCleaning Command Error, At least command parameter(MacroName) is not match.\n");
				return SYS_ABORTED;
			}
			break;
		case 4 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					READ_STRING(PRMS_PM4_MacroName_01+nCnt,szMacroName, &nCommStatus);
					if(STRCMP_L(szMacroType, szMacroName))
					{
						READ_STRING(PRMS_PM4_PreMRcp_01+nCnt, szPreMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM4_PreMRcp2_01+nCnt, szPreMacroRecipe2, &nCommStatus);
						READ_STRING(PRMS_PM4_PostMRcp_01+nCnt, szPostMacroRecipe1, &nCommStatus);
						READ_STRING(PRMS_PM4_PostMRcp2_01+nCnt, szPostMacroRecipe2, &nCommStatus);

						if((STRCMP_L(szPreMacroRecipe1,"") && STRCMP_L(szPreMacroRecipe2,""))
							&&(STRCMP_L(szPostMacroRecipe1,"") && STRCMP_L(szPostMacroRecipe2,"")))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM4 AutoDryCleaning Recipe is Null, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						
						if ( Reserved_1 == READ_DIGITAL(PM4_DryCleaningReserveDI, &nCommStatus))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM4 AutoDryCleaning Already Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else if (7 == READ_DIGITAL(CTC_PM4_CommStatus, &nCommStatus))
						{

							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM4,szEvent);
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_4, &nCommStatus);
							printf("PM4 AutoDryCleaning Reserved, will be command perform after StandbyMode.\n");
							return SYS_ABORTED;
						}
						else if ( (7 != READ_DIGITAL(CTC_PM4_CommStatus, &nCommStatus)) && (3 != READ_DIGITAL(CTC_PM4_CommStatus, &nCommStatus)))
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
							printf("PM4 AutoDryCleaning Module Status isn't CTCinUse or Standby.\n");
							return SYS_ABORTED;
						}
						else{
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM4,szEvent);
				...
				WRITE_DIGITAL( HOSTCMD_HCACK, NACK_2, &nCommStatus);
				printf("PM4 AutoDryCleaning Command Error, At least command parameter(MacroName) is not match.\n");
				return SYS_ABORTED;
			}
			break;
		default :
	...
	else if ( STRCMP_L(szAutoPMJob, "PMJobAbort"))
	{
		switch(nPMID)
		{
		case 1 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					...
					if(STRCMP_L(szMacroType, szMacroName))
					{
						...
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM1 AutoDryCleaning is not Run or Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else {
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM1,szEvent);
		...
		case 2 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					...
					if(STRCMP_L(szMacroType, szMacroName))
					{
						...
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM2 AutoDryCleaning is not Run or Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else {
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM2,szEvent);
		...
		case 3 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					...
					if(STRCMP_L(szMacroType, szMacroName))
					{
						...
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM3 AutoDryCleaning is not Run or Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else {
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM3,szEvent);
		...
		case 4 :
			{
				for(nCnt = 0; nCnt < 3; nCnt++)
				{
					...
					if(STRCMP_L(szMacroType, szMacroName))
					{
						...
						{
							WRITE_DIGITAL( HOSTCMD_HCACK, NACK_5, &nCommStatus);
							printf("PM4 AutoDryCleaning is not Run or Reserved, Can't command perform now.\n");
							return SYS_ABORTED;
						}
						else {
							WRITE_FUNCTION_EVENT(MACRO_MANIT_PM4,szEvent);
...
Module_Status Program_Main() {
	...
	if ( nDl2 < 1 ) {
		...
		}else if ( STRCMP_L( szBuffer , "PMJobCreate") || STRCMP_L( szBuffer , "PMJobAbort"))
		{
			return AutoPM_Control( pszEd );
		}
	}
	else {
