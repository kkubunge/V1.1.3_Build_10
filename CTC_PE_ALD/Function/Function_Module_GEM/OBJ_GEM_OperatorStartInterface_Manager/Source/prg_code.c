...
IO_Name_String_Map IO_STR_Map_Table[] = {
	...
	{ "CTC.MAIN_CONTROL$0"		, _K_D_IO	,	PORT_CONTROL		,	0	} ,
	{ "CTC.MID_NAME$0"			, _K_S_IO	,	MID_NAME			,	0	} ,
	{ "CTC.JID_READ$0"			, _K_S_IO	,	JID_READ			,	0	} ,
	{ "CTC.RECIPE_FILE$0"		, _K_S_IO	,	RECIPE_FILE			,	0	} ,
	{ "CTC.START_SLOT$0"		, _K_D_IO	,	START_SLOT			,	0	} ,
	{ "CTC.END_SLOT$0"			, _K_D_IO	,	END_SLOT			,	0	} ,
	{ "CTC.LOOP_COUNT$0"		, _K_D_IO	,	LOOP_COUNT			,	0	} ,
	{ "CTC.IN_PATH$0"			, _K_D_IO	,	IN_PATH				,	0	} ,
	{ "CTC.OUT_PATH$0"			, _K_D_IO	,	OUT_PATH			,	0	} ,
	{ "CTC.MAIN_STATUS$0"		, _K_D_IO	,	PORT_STATUS			,	0	} ,
...
// jelee Add Start for Wafer Status Check Option at 2009.04.02
	...
	if( nWfrChkOption == Check ) {
		...
		for(j=CM1_C01_Wafer+S_Slot-1; j<=CM1_C01_Wafer+E_Slot-1; j++) {
...
//	SYSTEMTIME SysTime;
	...
	nOPRStartMode = READ_DIGITAL(OPERATOR_START, &CommStatus);
	if ( ON != nOPRStartMode ) {
		WRITE_DIGITAL( OPERATOR_START, ON, &CommStatus);
	}
...
void Program_Enter_Code() {
	...
	if ( strcmp( Str1 , "2" ) == 0 || strcmp( Str1 , "3" ) == 0 || strcmp( Str1 , "4" ) == 0 ) PORTID = atoi( Str1 ) - 1;
	else PORTID = PORT1; 
