...
// Log File Name
#define LOG_FILE_PATH				"_Log\\Test.log"
...
static BOOL _gInitLogDll(const char *szLogFile, const char *szCfgFile, BOOL bConfigLog)
{
	...
	do {
		...
		if(NULL != g_hLogDllModule)
		{
			...
			// _gTextLogDll_Command("DELIMITER_TAB", NULL);			// 2013.06.03
			// _gTextLogDll_Command("YEAR_LOG_TRUE", NULL);			// 2013.06.03
			// _gTextLogDll_Command("AUTO_CREATE_FILE_TRUE", NULL);	// 2013.06.03
