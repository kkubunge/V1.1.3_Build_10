...
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
#define		ALARM_S_VENT_TIMEOUT	1031
#define		ALARM_F_VENT_TIMEOUT	1032
#define		ALARM_S_PUMP_TIMEOUT	1033
#define		ALARM_F_PUMP_TIMEOUT	1034
#define		ALARM_RPUMP_TIMEOUT		1037
#define     ALARM_LEAK_RATE_ERR		1046
#define     ALARM_LEAK_AVG_ERR		1047
//------------------------------------------------------------------------------------------
typedef enum
{ 
	ULL_UNLOCK, 
...
FILE*   g_fLog    = NULL;
#define FILE_PATH ".\\Parameter\\LeakCheckLog_BM1.cfg"
...
IO_Name_String_Map IO_STR_Map_Table[] = {
	...
	{ "FC_BM1_VAC_CTRL"				, _K_D_IO	, FC_Vacuum_BM1				,   0   } ,

	{ "BM1.LockPumpDM"				, _K_D_IO	, LockPumpDM_BM1			,	0	} ,
	{ "BM1.VacuumStatusDM"			, _K_D_IO	, VacuumStatusDM_BM1		,	0	} ,
	{ "BM1.RoughVvXO"				, _K_D_IO	, RoughVvXO_BM1				,	0	} ,
	{ "BM1.VentVvXO"				, _K_D_IO	, VentVvXO_BM1				,	0	} ,
	{ "BM1.ATMVACSensorXI"			, _K_D_IO	, ATMVACSensorXI			,	0	} ,
	{ "BM1.CGChmPrsAI"				, _K_A_IO	, CGChmPrsAI				,	0	} ,
	{ "BM1.CGPumpPrsAI"				, _K_A_IO	, CGPumpPrsAI				,	0	} ,
	{ "BM1.DoorLXI"					, _K_D_IO	, BM_DoorLXI				,	0	} ,
	{ "BM1.DoorRXI"					, _K_D_IO	, BM_DoorRXI				,	0	} ,
...
//-------------------------------------------------------------------------------------
	...
	{ "PRMD_BM1_SVENT_TMO"			, _K_D_IO	, PRMD_BM1_SVENT_TMO		,	0	} ,
	{ "PRMD_BM1_FVENT_TMO"			, _K_D_IO	, PRMD_BM1_FVENT_TMO		,	0	} ,
	{ "PRMD_BM1_SPUMP_TMO"			, _K_D_IO	, PRMD_BM1_SPUMP_TMO		,	0	} ,
	{ "PRMD_BM1_FPUMP_TMO"			, _K_D_IO	, PRMD_BM1_FPUMP_TMO		,	0	} ,
	{ "PRMD_BM1_RPUMP_TMO"			, _K_D_IO	, PRMD_BM1_RPUMP_TMO		,	0	} ,
	{ "PRMD_BM1_OVENT_TIME"			, _K_D_IO	, PRMD_BM1_OVENT_TIME		,	0	} ,
	{ "PRMA_BM1_VENT_TD" 			, _K_A_IO	, LL_VENT_DELAYTIME		 	,	0	} ,
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
	{ "BM1.Leak_Test_Number"		, _K_D_IO	, BM1_Leak_Test_Number		,	0	} ,
	{ "BM1.Leak_Remain_Time"		, _K_D_IO	, BM1_Leak_Test_Time		,	0	} ,
	{ "BM1.Leak_End"				, _K_D_IO	, BM1_Leak_End				,	0	} ,

	{ "BM1.Sys.Year"				, _K_D_IO	, BM1_Year					,	0	} ,
	{ "BM1.Sys.Month"				, _K_D_IO	, BM1_Month 				,	0	} ,
	{ "BM1.Sys.Day"					, _K_D_IO	, BM1_Day 					,	0	} ,
	{ "BM1.Sys.Hour"				, _K_D_IO	, BM1_Hour 					,	0	} ,
	{ "BM1.Sys.Min"					, _K_D_IO	, BM1_Min 					,	0	} ,
	{ "BM1.Sys.Sec"					, _K_D_IO	, BM1_Sec 					,	0	} ,
	
	{ "BM1.Leak_Rate1"				, _K_A_IO	, BM1_Leak_Rate1			,	0	} ,
	{ "BM1.Leak_Rate2"				, _K_A_IO	, BM1_Leak_Rate2			,	0	} ,
	{ "BM1.Leak_Rate3"				, _K_A_IO	, BM1_Leak_Rate3			,	0	} ,
	{ "BM1.Leak_Rate4"				, _K_A_IO	, BM1_Leak_Rate4			,	0	} ,
	{ "BM1.Leak_Rate5"				, _K_A_IO	, BM1_Leak_Rate5			,	0	} ,
	{ "BM1.Leak_Rate6"				, _K_A_IO	, BM1_Leak_Rate6			,	0	} ,
	{ "BM1.Leak_Rate7"				, _K_A_IO	, BM1_Leak_Rate7			,	0	} ,
	{ "BM1.Leak_Rate8"				, _K_A_IO	, BM1_Leak_Rate8			,	0	} ,
	{ "BM1.Leak_Rate9"				, _K_A_IO	, BM1_Leak_Rate9			,	0	} ,
	{ "BM1.Leak_Rate10"				, _K_A_IO	, BM1_Leak_Rate10			,	0	} ,

	{ "BM1.Leak_LastRate"			, _K_A_IO	, BM1_Leak_LastRate			,	0	} ,

	{ "BM1.Leak_PumpingTime_H"		, _K_D_IO	, BM1_Leak_PumpingTime_H	,	0	} ,
	{ "BM1.Leak_PumpingTime_M"		, _K_D_IO	, BM1_Leak_PumpingTime_M	,	0	} ,
	{ "BM1.Leak_WaitingTime_H"		, _K_D_IO	, BM1_Leak_WaitingTime_H	,	0	} ,
	{ "BM1.Leak_WaitingTime_M"		, _K_D_IO	, BM1_Leak_WaitingTime_M	,	0	} ,
	{ "FC_BM_VENT_TYPE"				, _K_D_IO	, BM_VentType				,	0	} ,

	{ "BM1.LeakChk_Message"			, _K_S_IO	, BM1_LeakChk_Message		,	0	} ,
	{ "BM1.Leak_PumpRemain_Time"	, _K_S_IO	, BM1_Leak_PumpRemain_Time	,	0	} ,
	{ "BM1.Leak_WaitRemain_Time"	, _K_S_IO	, BM1_Leak_WaitRemain_Time	,	0	} ,

    { "BM1.pcCHM.LeakAve"           , _K_A_IO   , BM1_PC_LEAKAVE			,	0   } ,	
    { "BM1.psLKCHK.LastTIme"        , _K_S_IO   , BM1_PC_LKCHK_LASTTIME		,	0   } ,
    { "vBM1.Logging"                , _K_D_IO   , BM1_LOGGING				,	0   } ,
	{ "CTC.MAIN_CONTROL"			, _K_D_IO	, LOT_CONTROL			    ,	0	} ,
	{ "CTC.MAIN_CONTROL2"			, _K_D_IO	, LOT2_CONTROL		     	,	0	} ,
	{ "CTC.MAIN_CONTROL3"			, _K_D_IO	, LOT3_CONTROL		        ,	0	} ,
	{ "TMC_BM1_RPUMP_CONTROL"		, _K_F_IO	, BM1_PUMP_CONTROL			,	0	} ,
	{ "TMC_BM1_DOOR_CONTROL"		, _K_F_IO	, DOOR_CONTROL		        ,	0	} ,
	{ "TMC_BM1_OVERPRESSURE"		, _K_F_IO	, TMC_BM1_OVERPRESSURE		,   0   } ,
	...
	{ "PRMD_BM1_ALC_RATE_LIMIT"      , _K_D_IO	,	LeakRateLimit		    ,	0	} ,
	{ "PRMD_BM1_ALC_AVG_LIMIT"       , _K_D_IO	,	LeakAvgLimit		    ,	0	} ,

	{ "BM1.LeakChk_Log_Rate1"		, _K_D_IO	, Log_Rate1					,	0	} ,
	{ "BM1.LeakChk_Log_Rate2"		, _K_D_IO	, Log_Rate2					,	0	} ,
	{ "BM1.LeakChk_Log_Rate3"		, _K_D_IO	, Log_Rate3					,	0	} ,
	{ "BM1.LeakChk_Log_Rate4"		, _K_D_IO	, Log_Rate4					,	0	} ,
	{ "BM1.LeakChk_Log_Rate5"		, _K_D_IO	, Log_Rate5					,	0	} ,
	{ "BM1.LeakChk_Log_Avg1"		, _K_D_IO	, Log_Avg1					,	0	} ,
	{ "BM1.LeakChk_Log_Avg2"		, _K_D_IO	, Log_Avg2					,	0	} ,
	{ "BM1.LeakChk_Log_Avg3"		, _K_D_IO	, Log_Avg3					,	0	} ,
	{ "BM1.LeakChk_Log_Avg4"		, _K_D_IO	, Log_Avg4					,	0	} ,
	{ "BM1.LeakChk_Log_Avg5"		, _K_D_IO	, Log_Avg5					,	0	} ,
	{ "BM1.LeakChk_Log_Time1"       , _K_S_IO   , Log_Time1					,	0   } ,
	{ "BM1.LeakChk_Log_Time2"       , _K_S_IO   , Log_Time2					,	0   } ,
	{ "BM1.LeakChk_Log_Time3"       , _K_S_IO   , Log_Time3					,	0   } ,
	{ "BM1.LeakChk_Log_Time4"       , _K_S_IO   , Log_Time4					,	0   } ,
	{ "BM1.LeakChk_Log_Time5"       , _K_S_IO   , Log_Time5					,	0   } ,	

//-------------------------------------------------------------------------------------
	// 2008.11.17 by jonghyuk (Cycle Purge)
	{ "FC_BM1_CYCPURGE_CTRL"		, _K_D_IO	, FC_CYCLE_PURGE_BM1		,	0	} ,
	{ "PRMA_BM1_CP_SVENT_PRES"		, _K_A_IO	, PRMA_BM1_CP_SVENT_PRES	,	0	} ,
	{ "PRMA_BM1_CP_FVENT_PRES"		, _K_A_IO	, PRMA_BM1_CP_FVENT_PRES	,	0	} ,
	{ "PRMA_BM1_CP_SPUMP_PRES"		, _K_A_IO	, PRMA_BM1_CP_SPUMP_PRES	,	0	} ,
	{ "PRMA_BM1_CP_FPUMP_PRES"		, _K_A_IO	, PRMA_BM1_CP_FPUMP_PRES	,	0	} ,

	{ "PRMA_BM1_CP_RPUMP_PRES"		, _K_A_IO	, PRMA_BM1_CP_RPUMP_PRES	,	0	} ,

	{ "PRMD_BM1_CP_SVENT_TMO"		, _K_D_IO	, PRMD_BM1_CP_SVENT_TMO		,	0	} ,
	{ "PRMD_BM1_CP_FVENT_TMO"		, _K_D_IO	, PRMD_BM1_CP_FVENT_TMO		,	0	} ,

	{ "PRMD_BM1_CP_SPUMP_TMO"		, _K_D_IO	, PRMD_BM1_CP_SPUMP_TMO		,	0	} ,
	{ "PRMD_BM1_CP_FPUMP_TMO"		, _K_D_IO	, PRMD_BM1_CP_FPUMP_TMO		,	0	} ,

	{ "PRMD_BM1_CP_RPUMP_TMO"		, _K_D_IO	, PRMD_BM1_CP_RPUMP_TMO		,	0	} ,
	{ "PRMD_BM1_CP_OVENT_TIME"		, _K_D_IO	, PRMD_BM1_CP_OVENT_TIME	,	0	} ,

	{ "PRMA_BM1_CP_VENT_TD" 		, _K_A_IO	, LL_CP_VENT_DELAYTIME		,	0	} ,

	{ "PRMD_BM1_CYCLE_PURGE_CNT"	, _K_D_IO	, PRMD_BM1_CYCLE_PURGE_CNT	,	0	} ,
	{ "BM1.CYCLE_PURGE_RCNT_DM"		, _K_D_IO	, BM1_CYCLE_PURGE_RCNT_DM	,	0	} ,
	{ "BM1.CYCLE_PURGE_STS_DM"		, _K_D_IO	, BM1_CYCLE_PURGE_STS_DM	,	0	} ,
	//... 2017.03.06
	{ "PRMA_BM1_TOTAL_VENT_TIME"	, _K_A_IO	, PRMA_BM1_TOTAL_VENT_TIME	,	0	} ,
	{ "PRMD_BM1_STABLE_OVERVENT"	, _K_D_IO	, PRMD_BM1_STABLE_OVERVENT	,	0	} ,
	//... 2017.03.07
	{ "PRMD_BM1_FINAL_PUMP"			, _K_D_IO	, PRMD_BM1_FINAL_PUMP		,	0	} ,
...
Module_Status SetOverPres() {
	...
	// Check Pre_Vacuum
	if( READ_DIGITAL( RoughVvXO_BM1 , &CommStatus ) == BM_OPENFAST &&
		...
		if ( READ_DIGITAL( LOT_CONTROL  , &CommStatus ) ==  LS_RUNNING ||
			 ...
			 RUN_FUNCTION(TMC_BM1_OVERPRESSURE, "OPEN_OPRES_VALVE");
		}
	}
...
Module_Status CyclePurge_Pump(){
	...
	WRITE_DIGITAL( BM1_CYCLE_PURGE_STS_DM, CYCLE_PURGE_STATE_PUMP, &CommStatus);
	WRITE_DIGITAL( VacuumStatusDM_BM1 , VS_GOVAC , &CommStatus );        		

	// Lock BM1
	WRITE_DIGITAL( LockPumpDM_BM1 , ULL_LOCK , &CommStatus );
	...
	if( READ_DIGITAL( RoughVvXO_BM1 , &CommStatus ) == BM_OPENFAST && 
		...
		WRITE_DIGITAL( VacuumStatusDM_BM1 , VS_VACUUM , &CommStatus );
		return SYS_SUCCESS;
	}
	...
	if ( SYS_ABORTED == res ) 
	{
		...
		WRITE_DIGITAL( VacuumStatusDM_BM1 , VS_ABORT , &CommStatus );
	}
	else
	{
		WRITE_DIGITAL( VacuumStatusDM_BM1 , VS_VACUUM , &CommStatus );
	...
	// Unlock BM1
	WRITE_DIGITAL( LockPumpDM_BM1 , ULL_UNLOCK , &CommStatus );
...
//		if ( READ_DIGITAL( SlowRoughVvDO_BM1 , &CommStatus ) != CO_CLOSE ) break;
//		if ( READ_DIGITAL( FastRoughVvDO_BM1  , &CommStatus) != CO_OPEN ) break;	
		if ( READ_DIGITAL( RoughVvXO_BM1  , &CommStatus) != BM_OPENFAST ) break;
		if ( READ_DIGITAL( VacuumStatusDM_BM1 , &CommStatus) != VS_VACUUM ) break;
		return SYS_SUCCESS;
	}while(0);
	if ( !WAIT_SECONDS( 0.5 ) ) return SYS_ABORTED;
	...
	RUN_FUNCTION(TMC_BM1_OVERPRESSURE, "CLOSE_OPRES_VALVE");
	// WRITE_DIGITAL( BM1_OverPresVvDO , CO_CLOSE , &CommStatus );	
//	WRITE_DIGITAL( SlowVentVvDO_BM1 , CO_CLOSE , &CommStatus );
//	WRITE_DIGITAL( FastVentVvDO_BM1 , CO_CLOSE , &CommStatus );
	WRITE_DIGITAL( VentVvXO_BM1 , BM_CLOSE , &CommStatus );

//	WRITE_DIGITAL( SlowRoughVvDO_BM1 , CO_CLOSE , &CommStatus );
//	WRITE_DIGITAL( FastRoughVvDO_BM1 , CO_CLOSE , &CommStatus );
	WRITE_DIGITAL( RoughVvXO_BM1 , BM_CLOSE , &CommStatus );
	if ( !WAIT_SECONDS( 2 ) ) return SYS_ABORTED;

	// Do Roughing Line Pump
	if ( Wait_Pump_Pressure ( BM1_PUMP_CONTROL, 
		                      CGPumpPrsAI , 
...
//	WRITE_DIGITAL( SlowRoughVvDO_BM1 , CO_CLOSE , &CommStatus );
	...
	if ( READ_DIGITAL( LOT_CONTROL  , &CommStatus ) ==  LS_RUNNING ||
		 ...
		 READ_DIGITAL( LOT3_CONTROL  , &CommStatus ) == LS_RUNNING ) {
		RUN_FUNCTION(TMC_BM1_OVERPRESSURE, "OPEN_OPRES_VALVE");
		// WRITE_DIGITAL( BM1_OverPresVvDO , CO_OPEN , &CommStatus );
	}
...
Module_Status Vacuum_Pump_Sub() {
	...
	//LogEvent("BM1", "PUMP", "Start", "");				// 2013.11.15
	...
	LogEvent("BM1", "PUMP", "Start", "");					// 2014.7.25
	...
	LogEvent("BM1", "SOFTPUMP", "Start", "");				// 2014.7.25
	// Do Chamber Pump by Slow Rough Valve
	if (Pump_Wait(CGChmPrsAI , 
					RoughVvXO_BM1 ,
					BM_OPENSLOW ,
	...
	LogEvent("BM1", "SOFTPUMP", "End", "");		    		// 2014.7.25

	// Close Slow Rough Valve
	WRITE_DIGITAL( RoughVvXO_BM1 , BM_CLOSE , &CommStatus );

	LogEvent("BM1", "FASTPUMP", "Start", "");				// 2014.7.25
	// Do Chamber Pump by Fast Rough Valve
	if ( Pump_Wait( CGChmPrsAI , 
					RoughVvXO_BM1 ,
					BM_OPENFAST ,
	...
	LogEvent("BM1", "FASTPUMP", "End", "");					// 2014.7.25
	...
	LogEvent("BM1", "PUMP", "End", "");						// 2014.7.25
...
Module_Status CyclePurge_Vent() {
	...
	// Set BM1 Vent Status
	WRITE_DIGITAL( BM1_CYCLE_PURGE_STS_DM, CYCLE_PURGE_STATE_VENT, &CommStatus);
    WRITE_DIGITAL( VacuumStatusDM_BM1 , VS_GOATM , &CommStatus );	
...
//	WRITE_DIGITAL( FastVentVvDO_BM1 , CO_CLOSE , &CommStatus );
	...
	{
	    WRITE_DIGITAL( VacuumStatusDM_BM1 , VS_ATM , &CommStatus );	
	}
...
//	int OverVent_Time;
	...
	Target = READ_ANALOG( PRMA_BM1_CP_FVENT_PRES	, &CommStatus );
...
//					VACSensorDI
	...
	// Do Over Vent
	// 2005.03.31 by cskim, Modified
	if ( !WAIT_SECONDS( READ_DIGITAL( PRMD_BM1_CP_OVENT_TIME , &CommStatus ) ) ) {
		msRet = SYS_ABORTED;
	}
//	WRITE_DIGITAL( FastVentVvDO_BM1 , CO_CLOSE , &CommStatus );
	WRITE_DIGITAL( VentVvXO_BM1 , BM_CLOSE , &CommStatus );
...
Module_Status Vacuum_Vent_Sub() {
	...
	// Check whether Chamber is Vent or not
	Pressure  = READ_ANALOG(CGChmPrsAI	    	, &CommStatus );
	Target    = READ_ANALOG(PRMA_BM1_FVENT_PRES	, &CommStatus );
	if ((READ_DIGITAL( ATMVACSensorXI , &CommStatus ) == ATM_SENSOR) && (Pressure >= Target)) 
		return SYS_SUCCESS;

	//LogEvent("BM1", "VENT", "Start", "");				// 2013.11.15


	//2009.06.09
	if (RUN_FUNCTION(TMC_ISOGATE_CONTROL , "CLOSE BM1" ) == SYS_ABORTED ) return SYS_ABORTED;
	...
	LogEvent("BM1", "VENT", "Start", "");				// 2014.7.25
	...
	LogEvent("BM1", "SOFTVENT", "Start", "");			// 2014.7.25
	// Do Slow Vent
	...
	LogEvent("BM1", "SOFTVENT", "End", "");			// 2014.7.25

	LogEvent("BM1", "FASTVENT", "Start", "");		// 2014.7.25
	// Do Fast Vent
	if (Vent_Wait( CGChmPrsAI , 
					VentVvXO_BM1 ,
					BM_OPENFAST ,
	...
	LogEvent("BM1", "FASTVENT", "End", "");			// 2014.7.25

	// Do Over Vent
	// 2005.03.31 by cskim, Modified
	if (!WAIT_SECONDS( READ_DIGITAL(PRMD_BM1_OVENT_TIME , &CommStatus ))) {
		msRet = SYS_ABORTED;
	}

	nStableOverVent = READ_DIGITAL(PRMD_BM1_STABLE_OVERVENT,&CommStatus);
	...
	do
	{
		...
		if(READ_ANALOG(PRMA_BM1_TOTAL_VENT_TIME,&CommStatus) <= dbTotalTime)
		{
	...
	LogEvent("BM1", "VENT", "End", "");				// 2013.11.15
	return msRet;
}
...
{
	int nComSts = 0;
    WRITE_DIGITAL(BM1_LOGGING, NY_NO , &nComSts);
	WRITE_ANALOG (BM1_PC_LEAKAVE     , dData, &nComSts);
	WRITE_DIGITAL(BM1_LOGGING, NY_YES, &nComSts);
}
//------------------------------------------------------------------------------------------
void saveLkChkTime(void)
{
    ...
    WRITE_DIGITAL(BM1_LOGGING, NY_NO, &nComSts);
	WRITE_STRING (BM1_PC_LKCHK_LASTTIME, buf, &nComSts);
	WRITE_DIGITAL(BM1_LOGGING, NY_YES, &nComSts);
}
...
Module_Status Vacuum_Leak() {
	...
	//////////////////////////////////////////////////////////////////
	// Begin Initialize
	WRITE_DIGITAL( BM1_Leak_End , OFFON_OFF , &CommStatus );
	if ( READ_DIGITAL( BM1_Leak_Test_Number , &CommStatus ) == 0 ) {
		sprintf( Buffer_Str , "%s Leak Test count check...", NAME_CHAMBER);
		WRITE_STRING( BM1_LeakChk_Message , Buffer_Str , &CommStatus );
		return SYS_SUCCESS;
	}

	// Set zero to each Leak Rate Channel
	for (i = 0 ; i < 11 ; i++) 
		WRITE_ANALOG ( BM1_Leak_Rate1 + i , 0 , &CommStatus );
	saveIO();

	// Set Time zero to Leak Wait Remain Time Channel
	WRITE_STRING( BM1_Leak_WaitRemain_Time , "00:00:00" , &CommStatus );

	// Set Time zero to Leak Pump Remain Time Channel
	WRITE_STRING( BM1_Leak_PumpRemain_Time , "00:00:00" , &CommStatus );
	// End Initialize
	//////////////////////////////////////////////////////////////////
	...
	WRITE_STRING( BM1_LeakChk_Message , Buffer_Str , &CommStatus );
	if ( Vacuum_Pump() == SYS_ABORTED) 
		return SYS_ABORTED;

	//////////////////////////////////////////////////////////////////
	// Begin Continued Pump
	Time = READ_DIGITAL( BM1_Leak_PumpingTime_H , &CommStatus )*3600 + READ_DIGITAL( BM1_Leak_PumpingTime_M , &CommStatus )*60;
	...
	while (TRUE) {
		...
		nMin  = nTemp / 60;
		nSec  = nTemp % 60;
		sprintf( BM1_Time , "%02d:%02d:%02d" , nHour , nMin , nSec );
		WRITE_STRING(BM1_Leak_PumpRemain_Time , BM1_Time , &CommStatus );
	...
	//////////////////////////////////////////////////////////////////
	// Begin Wait Time
	Time = READ_DIGITAL( BM1_Leak_WaitingTime_H , &CommStatus )*3600 + READ_DIGITAL( BM1_Leak_WaitingTime_M , &CommStatus )*60;
	...
	while (TRUE) {
		...
		nSec  = nTemp % 60;
		sprintf( BM1_Time , "%02d:%02d:%02d" , nHour , nMin , nSec );
		WRITE_STRING( BM1_Leak_WaitRemain_Time , BM1_Time , &CommStatus );
		if		( S_TIMER_REACH( Time ) ) break;
		else if ( !WAIT_SECONDS ( 0.1 ) ) return SYS_ABORTED;
	}
	// End Wait Time
	...
	WRITE_DIGITAL( BM1_Year  , Pres_Time.tm_year+1900 , &CommStatus );
	WRITE_DIGITAL( BM1_Month , Pres_Time.tm_mon + 1   , &CommStatus );
	WRITE_DIGITAL( BM1_Day   , Pres_Time.tm_mday      , &CommStatus );
	WRITE_DIGITAL( BM1_Hour  , Pres_Time.tm_hour      , &CommStatus );
	WRITE_DIGITAL( BM1_Min   , Pres_Time.tm_min       , &CommStatus );
	WRITE_DIGITAL( BM1_Sec   , Pres_Time.tm_sec       , &CommStatus );
	...
	for ( CurrCount = 0 ; CurrCount < 10 ; CurrCount++ ) {
		...
		WRITE_STRING( BM1_LeakChk_Message , Buffer_Str , &CommStatus );
		while (TRUE) {
			// If User click Stop Leak Check on screen, BM1_Leak_End is changed OFFON_ON !!!
			if (READ_DIGITAL( BM1_Leak_End , &CommStatus ) == OFFON_ON ) {
				Time = (int)( 60 - ( (int)S_TIMER_ELAPSED() % 60 ) );
				WRITE_DIGITAL( BM1_Leak_Test_Time , Time , &CommStatus );
			} else {
				Time = (int)( ( 60 * READ_DIGITAL( BM1_Leak_Test_Number , &CommStatus ) ) -
		...
		WRITE_ANALOG(BM1_Leak_Rate1 + CurrCount , Result*1000 , &CommStatus );
		...
		if (READ_DIGITAL(BM1_Leak_Test_Number , &CommStatus) == CurrCount+1) break;
		if (READ_DIGITAL(BM1_Leak_End , &CommStatus) == OFFON_ON) {
			WRITE_DIGITAL(BM1_Leak_End , OFFON_OFF , &CommStatus);
			break;
		}
		...
		if (FALSE == bSuccess) 
		{
			...
			if (AlmResult != ALM_RETRY)
			{
				...
				WRITE_ANALOG( BM1_Leak_LastRate , Result*1000 , &CommStatus );
				//2013.01.09 
				saveIO();
	...
	WRITE_STRING( BM1_LeakChk_Message , Buffer_Str , &CommStatus );
	WRITE_DIGITAL( RoughVvXO_BM1 , BM_OPENFAST , &CommStatus );
		break;
...
Module_Status ExecuteCyclePurge()
{
	...
	nTargetCycleCount = READ_DIGITAL(PRMD_BM1_CYCLE_PURGE_CNT, &CommStatus);
	if(nTargetCycleCount < 0 ) nTargetCycleCount = 0;

	// Cycle Purge 횟수만큼 Purge실시
	for(step=0; step<nTargetCycleCount; step++)
	{
		WRITE_DIGITAL(BM1_CYCLE_PURGE_RCNT_DM, step+1, &CommStatus);
	...
	WRITE_DIGITAL( BM1_CYCLE_PURGE_STS_DM, CYCLE_PURGE_STATE_STOP, &CommStatus);
...
//	char szCmd[80];
	...
	/*
	if (SIMULATION_MODE) {
		_LOG("-----> '%s' Started in BM1 Vac(Sim)", Ed);
		sprintf(szCmd,"BM1 %s", RunStr);
		if(! g_DynIO.dRUN_FUNCTION(TMSIM_BM1, szCmd)) msRet = SYS_ABORTED;

		_LOG("-----> '%s' Finished in BM1 Vac(Sim)", Ed);

		return msRet;
	}
	*/

	if (READ_DIGITAL( FC_Vacuum_BM1 , &CommStatus ) == ONOFF_OFF )
		return SYS_SUCCESS;

	if (Dl < 1) {
		printf( "---> BM1 Vacuum Control Parameter Error\n" );
		return SYS_ABORTED;
	}

	// 2008.11.17 by jonghyuk (Cycle Purge)
	if	( STRCMP_L( RunStr , "CYCLE_PURGE" ) ){
		if ( READ_DIGITAL( FC_CYCLE_PURGE_BM1 , &CommStatus ) == ONOFF_OFF ) return SYS_SUCCESS;

		msRet = ExecuteCyclePurge();
		_LOG("-----> Finished (%s) in BM1 CyclePurgeFunc", Ed);
		return msRet;
	}	

	if ( READ_DIGITAL( FC_Vacuum_BM1 , &CommStatus ) == ONOFF_OFF ) return SYS_SUCCESS;	
	_LOG("-----> Started (%s) in BM1VacFunc", Ed);
	...
	{
		if(READ_DIGITAL(PRMD_BM1_FINAL_PUMP,&CommStatus) == OFFON_ON)
		{
			msRet = Vacuum_Pump();
		}
	}
		...
		printf( "---> BM1 Vacuum Check Error - Not Support Code %s\n" , Ed );
		msRet =  SYS_ABORTED;
	}
	_LOG("-----> Finished (%s) in BM1VacFunc", Ed);
	return msRet;
}
