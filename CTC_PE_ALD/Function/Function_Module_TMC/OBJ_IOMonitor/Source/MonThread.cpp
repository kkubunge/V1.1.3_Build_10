...
void CMonThread::DoMonitor(int nThreadNo)
{
	switch(nThreadNo)
	{
	case 0: DoMonitor(); break;	/* nThreadNo = 0 : Default Monitor Function */
	case MFNO_Monitor_Func_1: /* DoMonitor_1(nThreadNo); */ break;
	case MFNO_Monitor_Func_2: /* DoMonitor_2(nThreadNo); */ break;
	case MFNO_Monitor_Func_3: /* DoMonitor_3(nThreadNo); */ break;
	}
}
