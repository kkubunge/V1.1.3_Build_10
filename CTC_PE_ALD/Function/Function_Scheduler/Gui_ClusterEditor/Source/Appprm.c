...
BOOL	MAXVIEW_MODE		= FALSE;
BOOL	TITLE_MODE			= FALSE;
int		READONLY_LEVEL		= 0;
int		READONLY_LEVEL_IO	= -2;
char	READONLY_LEVEL_IO_NAME[256];
BOOL	GROUPBUTTONHIDE_MODE	= FALSE;
int		NAME_STYLE			= 0; // 2004.06.15
BOOL	ALLMOVE_MODE		= FALSE; // 2005.07.19
BOOL	NAMEONLY_MODE		= FALSE; // 2006.04.27
BOOL	SEARCH_MODE			= FALSE; // 2007.09.18
BOOL	VERSION_MODE		= FALSE; // 2007.09.18
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
...
void Set_Prm_MAXVIEW_MODE( int data )		{ MAXVIEW_MODE = data; }
BOOL Get_Prm_MAXVIEW_MODE()				{ return MAXVIEW_MODE; }

void Set_Prm_TITLE_MODE( int data )		{ TITLE_MODE = data; }
BOOL Get_Prm_TITLE_MODE()				{ return TITLE_MODE; }

void Set_Prm_GROUPBUTTONHIDE_MODE( int data )		{ GROUPBUTTONHIDE_MODE = data; }
BOOL Get_Prm_GROUPBUTTONHIDE_MODE()				{ return GROUPBUTTONHIDE_MODE; }

void Set_Prm_NAME_STYLE( int data ) { NAME_STYLE = data; } // 2004.06.15
int  Get_Prm_NAME_STYLE() { return NAME_STYLE; } // 2004.06.15

void Set_Prm_ALLMOVE_MODE( int data )	{ ALLMOVE_MODE = data; } // 2005.07.19
BOOL Get_Prm_ALLMOVE_MODE()				{ return ALLMOVE_MODE; } // 2005.07.19

void Set_Prm_NAMEONLY_MODE( int data )	{ NAMEONLY_MODE = data; } // 2006.04.27
BOOL Get_Prm_NAMEONLY_MODE()			{ return NAMEONLY_MODE; } // 2006.04.27
...
void Set_Prm_SEARCH_MODE( int data )		{ SEARCH_MODE = data; } // 2007.09.18
BOOL Get_Prm_SEARCH_MODE()				{ return SEARCH_MODE; } // 2007.09.18

void Set_Prm_VERSION_MODE( int data )		{ VERSION_MODE = data; } // 2007.09.18
BOOL Get_Prm_VERSION_MODE()				{ return VERSION_MODE; } // 2007.09.18
//------------------------------------------------------------------------------------------
