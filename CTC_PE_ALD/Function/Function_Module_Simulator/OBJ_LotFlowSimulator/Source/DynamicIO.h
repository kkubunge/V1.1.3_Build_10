...
public:
	...
	char* dREAD_IO_FROM_NAME(char *szIOName, int nIOType, char *szValue, BOOL *pResult);			// 2011.08.18
	//-----------------------------------------------------------------
	// 2008.12.03
	...
	void dWRITE_IO_FROM_NAME(char *szIOName, int nIOType, char *szValue, BOOL *pResult);			// 2009.12.21
	void dWRITE_STRING_FROM_NAME(char *szIOName, char *szValue, BOOL *pResult);						// 2009.12.21
...
2008.12.03	dWRITE_DIGITAL_FROM_NAME Func 추가
			...
			사용하지 말것.
2009.12.21	dWRITE_IO_FROM_NAME Func Type2 추가
			dWRITE_STRING_FROM_NAME Func 추가
2011.08.18	dREAD_IO_FROM_NAME Func 추가
--------------------------------------------------------------------*/
