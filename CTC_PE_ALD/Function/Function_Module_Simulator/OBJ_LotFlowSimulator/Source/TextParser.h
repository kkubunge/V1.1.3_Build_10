...
// Member Function
	...
	// 2011.08.18
	char* GetCurrPosition() { return m_pPosition; };
...
2009.12.21	한 Word가 80자 이상일 경우 처리 않되는 문제 수정
			최대 256 (NULL 포함) 자까지 처리되도록 수정함
2011.04.04	Find 기능 누락 사항 추가
2011.08.18	GetCurrPosition() Func 추가
