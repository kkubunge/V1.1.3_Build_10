...
bool CTextParser::GetBool(bool *pValue, char *szTrue, char *szFalse, char chToken)
{
	bool bRet = false;
	char szBuf[MAX_BUF] = "";
...
bool CTextParser::GetBool(char chToken, bool *pValue, char *szTrue, char *szFalse, char chTok_B)
{
	bool bRet = false;
...
{
	bool bRet = false;
	if(Token(chToken) == true) bRet = GetEnum(chToken, pValue, pszEnum, chTok_B);
	return bRet;
}
